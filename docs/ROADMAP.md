...
```bash
# msg-gw -v
msg-gw version 1.0.0-1 (2026.08.16)
```
...
|---|---|---|---|---|
| 1 | Pairing, session persistence, reconnect, list conversations | 1.0.0 | written | `msg-gw pair` shows a QR code, stores the session, reconnects with it and prints the conversation list as its own success check |
