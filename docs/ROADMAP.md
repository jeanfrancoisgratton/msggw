...
```bash
# rcs-mm_gw -v
rcs-mm_gw version 1.0.0-1 (2026.08.16)
```
...
|---|---|---|---|---|
| 1 | Pairing, session persistence, reconnect, list conversations | 1.0.0 | written | `rcs-mm_gw pair` shows a QR code, stores the session, reconnects with it and prints the conversation list as its own success check |
